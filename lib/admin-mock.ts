export type AdminTask={id:string|number;title:string;category:string;platform?:string;urgency:string;required:string;minutes:number;deadline:string;status:'上线'|'草稿'|'下线';url?:string;quick?:string;description?:string;recommendedCopy?:string;rawDeadline?:string|null;audience?:string;pinned?:boolean;urgentVisible?:boolean;daily?:boolean;multi?:boolean;history?:boolean;leader?:boolean;push?:boolean;urgentSortPosition?:number|null};
