...
export default async function Admin({params,searchParams}:{params:Promise<{slug?:string[]}>;searchParams:Promise<Record<string,string|string[]|undefined>>}){
  const db=await createClient(),adminPromise=requireAdmin(db);
