...
const items=[
  ...
  {key:'me',href:'/me',src:'/nav-icons/me.png',label:'养渝'}
] as const;
const navIconTuning={urgent:{scale:1,x:0,y:1},daily:{scale:1.16,x:-1,y:1},feed:{scale:0.95,x:0,y:0},guide:{scale:1,x:0,y:1},me:{scale:1.1,x:0,y:0}} as const;
